    ...
    return SafeArea(
      child: Scaffold(
        ...
        Center(
          ...
          children: [
            Image.asset('assets/images/pigoen.png',width: 200.w,),
            Text("No places to view", style: TextStyle(fontSize: 20.sp,color: Appthem().black,fontWeight: FontWeight.bold ),),
            Text("Select destination from home", style: TextStyle(fontSize: 18.sp,color: Colors.grey[600] ),)
          ],
        ))
      ),
    );
